...
var handleNativeToken = function handleNativeToken(tokenAddr) {
  return tokenAddr === '' || tokenAddr === constants.AddressZero ? ETH_NATIVE_TOKEN_ADDRESS : tokenAddr;
};
...
var SynapseRouter = /*#__PURE__*/function () {
  function SynapseRouter(chainId, provider) {
    !(chainId !== undefined) ?  invariant(false, 'CHAIN_ID_UNDEFINED')  : void 0;
    !(provider !== undefined) ?  invariant(false, 'PROVIDER_UNDEFINED')  : void 0;
    this.chainId = chainId;
    this.provider = provider;
    this.routerContract = new contracts.Contract(ROUTER_ADDRESS[chainId], SynapseRouter.INTERFACE, provider);
  }
...
SynapseRouter.INTERFACE = /*#__PURE__*/new abi$1.Interface(abi);
...
var SynapseSDK = /*#__PURE__*/function () {
  function SynapseSDK(chainIds, providers) {
    this.bridgeAbi = new abi$1.Interface(bridgeAbi);
    !(chainIds.length === providers.length) ?  invariant(false, "Amount of chains and providers does not equal")  : void 0;
    this.synapseRouters = {};
    this.providers = {};
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 9:
            filteredTokens = bridgeTokens.filter(function (bridgeToken) {
              return bridgeToken.symbol.length !== 0 && bridgeToken.token !== constants.AddressZero;
          ...
          case 17:
            ...
            maxAmountOut = bignumber.BigNumber.from(0);
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            bridgeContract = new contracts.Contract(bridgeAddress, this.bridgeAbi, this.providers[chainId]);
 ...
 */
var validateAndParseAddress = function validateAndParseAddress(address$1) {
  try {
...
exports.ETH_NATIVE_TOKEN_ADDRESS = ETH_NATIVE_TOKEN_ADDRESS;
exports.Ether = Ether;
...
exports.Token = Token;
exports.WETH9 = WETH9;
//# sourceMappingURL=sdk-router.cjs.development.js.map
